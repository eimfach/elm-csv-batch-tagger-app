    ...
    div []
        [ p
            ...
            [ span
                [ class "uk-label uk-text-small" ]
                [ text "NOTE" ]
            , text "    How auto tagging works: Choose a column and keyword to match datasets which have these keyword in a cell. Every matching dataset is then tagged by the tag you choose next."
            ]
